...
describe('Seo Component', () => {
    ...
    it('should correctly append keyword', () => {
      ...
      const expectedResult = [{ content: 'Description', name: 'description' }, { content: '', property: 'og:title' }, { content: 'Description', property: 'og:description' }, { content: 'website', property: 'og:type' }, { content: 'summary', name: 'twitter:card' }, { content: 'Author', name: 'twitter:creator' }, { content: '', name: 'twitter:title' }, { content: 'Description', name: 'twitter:description' }, { content: 'MOCK KEY 1, MOCK KEY 2', name: 'keywords' }];
